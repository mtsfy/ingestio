...
import { repoExists } from "@/lib/octo";
...
export default function Home() {
  ...
  const [url, setUrl] = useState("https://github.com/mtsfy/linkself");
  ...
  return (
    <div className="p-8 w-full">
      <div className="w-full flex flex-col gap-4">
        ...
        <textarea className="text-xs font-mono xl:w-1/2 min-h-[500px] p-4 border rounded resize-none" value={data.content} readOnly />
        <h1 className="font-bold text-lg">File Tree:</h1>
        <textarea className="text-xs font-mono xl:w-1/2 min-h-[400px] p-4 border rounded resize-none" value={data.directory} readOnly />
      </div>
    </div>
  );
}
